defmodule ReactChat.ChatTest do
  ...
  describe "rooms" do
    ...
    @valid_attrs %{description: "some description", name: "some name", type: 42}
    @update_attrs %{description: "some updated description", name: "some updated name", type: 43}
